...
import './css/SocialLinksStyles.css';
class SocialLinks extends Component {
    render(){
        return (
            <div>
                <button variant="secondary" className="small-icon"> 
                    <a href="https://www.instagram.com/peterzhang_007/?hl=en" target="_blank">
                ...
                <button variant="secondary" className="small-icon">
                    <a href="https://www.facebook.com/profile.php?id=100010412439188" target="_blank">
                ...
                <button variant="secondary" className="small-icon"> 
                    <a href="https://github.com/tinysheep007" target="_blank">
                ...
                <button variant="secondary" className="small-icon">
                    <a href="https://www.linkedin.com/in/peter-zhang-6908a0211/" target="_blank">
